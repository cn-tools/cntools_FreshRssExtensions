...
class Copy2ClipboardExtension extends Minz_Extension {
	...
	public function init() {
		...
		$this->registerHook('js_vars', array('Copy2ClipboardExtension', 'getCntJavascriptVars'));
		$this->registerHook('nav_menu', array('Copy2ClipboardExtension', 'getCntCopy2ClipboardBtn'));
	}
    ...
    //-----------------------------------------------------
    public static function getCntJavascriptVars($vars){
        $vars['copy2clipboard']['config']['findcolor'] = FreshRSS_Context::$user_conf->Copy2Clipboard["findcolor"] ?? '0';
    ...
    //-----------------------------------------------------
	public static function getCntCopy2ClipboardBtn() {
