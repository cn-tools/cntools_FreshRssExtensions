...
return array(
	'FeedTitleBuilder' => array(
		...
		'help4date' => 'With this code you can add the day date in your favorite format. Use your favorite web search engine to find out which params are available in the date function in php.<br />Look for details: <a href="https://www.php.net/manual/en/function.date.php" target="_blank" rel="noopener nofollow">https://www.php.net/manual/en/function.date.php</a><br />Example: {date}ymd{/date} => 20190401',
		'help4phpparseurl' => 'The url will be splited with the php function <code>parse_url</code> and you can get the specific value of the result.<br />Look for details: <a href="https://www.php.net/manual/en/function.parse-url.php" target="_blank" rel="noopener nofollow">https://www.php.net/manual/en/function.parse-url.php</a>',
		...
		'help4phpparseurlhostspecial' => 'Maybe the key word \'host\' gives you to much, so you can use the following special words. These are the by \'.\' (dot) splited values ​​of \'host\'.',
